      ...
      <section className={style.sectionHeaeder}>
        ...
        <div className={style.informationContainer}>
          <div>
            ...
            <p>
              Вибір експертів у світі тварин: наші клієнти підтверджують найвищу
              якість наших товарів!
            </p>
            <p>
              Рекомендації задоволених власників тварин: наші товари викликають
              у них тільки позитивні враження!
            </p>
            <p>
            ...
            <p>
              Довіра наших покупців - наша найкраща реклама: вони підтверджують,
              що наші товари перевершують всі очікування!
            </p>
            <p>
